...
//	Initialization of the constants
	...
	#define	combfilepath   "In_Comb_3_ConjComp_Compl_V3_p1.h"
	#define multfilepath  "In_Mult_3_ConjComp_Compl_V3_p1.h"
...
//	Definition of the arrays	
	...
	#include "In_Comb_3_ConjComp_V3_p1.h"
...
// Opening titles 
	...
	printf("*****************************************************************\n");
	printf("								 \n");
	printf("		        P A R T   O N E				 \n");
	printf("								 \n");
	printf("*****************************************************************\n");
	printf("								 \n");

//**********************************************************************************************
// 	Initialization of the multi dimensional arrays for the original and filtered 
...
//**********************************************************************************************
//	Beginning of the main loop (fully-contracted terms "Test[][]")
...
//	Writing of the output files
	...
	for(u = 0; u <= s-1; u++){
		...
		fprintf(CombFile,"Accombcomp1[%ld] = {{{%d,%d},{%d,%d},{%d,%d},{%d,%d},{%d,%d},{%d,%d},{%d,%d},{%d,%d}}};\n",
	...
	for(u = 0; u <= s-1; u++){
		...
		fprintf(MultFile,"Multcccvert1[%ld] = {%d};\n",u,MultcccVertices[u]);
