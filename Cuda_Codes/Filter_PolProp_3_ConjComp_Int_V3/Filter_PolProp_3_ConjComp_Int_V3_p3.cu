...
//	Initialization of the constants
	...
	#define combfilepath  "In_Comb_3_ConjComp_Compl_V3_p3.h"
	#define multfilepath  "In_Mult_3_ConjComp_Compl_V3_p3.h"	
...
//	Definition of the arrays
	...
	#include "In_Comb_3_ConjComp_V3_p3.h"
...
//	Writing of the output files
	...
	for(u = 0; u <= s-1; u++){
		...
		fprintf(CombFile,"Accombcomp3[%ld] = {{{%d,%d},{%d,%d},{%d,%d},{%d,%d},{%d,%d},{%d,%d},{%d,%d},{%d,%d}}};\n",
	...
	for(u = 0; u <= s-1; u++){
		...
		fprintf(MultFile,"Multcccvert3[%ld] = {%d};\n",u,MultcccVertices[u]);
